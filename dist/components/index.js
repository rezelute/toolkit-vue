...
var Xc = {
	...
	return n;
}, hl = /*#__PURE__*/ ml(pl, [["__scopeId", "data-v-d9fcf547"]]), gl = /*#__PURE__*/ ml(/* @__PURE__ */ _({
	__name: "Heading",
	props: {
		textSize: {},
		tag: {}
	...
	setup(e) {
		let t = e, n = c(() => t.textSize ? `heading-${t.textSize}` : "heading-lg");
		return (t, r) => (M(), l(ae(e.tag), { class: O(["heading", n.value]) }, {
			default: U(() => [L(t.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["class"]));
	}
}), [["__scopeId", "data-v-27cfce3b"]]), _l = {}, vl = {
	x: "0px",
	y: "0px",
	viewBox: "0 0 500 450",
...
var bl = /*#__PURE__*/ ml(_l, [["render", yl]]), xl = { class: "absolute inset-0 overflow-hidden pointer-events-none" }, Sl = {
	...
	key: 10,
	class: "absolute inset-0 overflow-hidden pointer-events-none"
}, El = /*#__PURE__*/ ml(/* @__PURE__ */ _({
	__name: "SectionPattern",
	props: { pattern: {} },
	setup(e) {
		return (t, n) => (M(), d("div", xl, [e.pattern === "grid-orbs" ? (M(), d(r, { key: 0 }, [
		...
		], 64)) : e.pattern === "aurora" ? (M(), d("div", Sl, [...n[4] ||= [
			f("div", {
			...
			class: "absolute top-0 right-0 w-[400px] h-[400px] rounded-full pointer-events-none",
			style: { background: "radial-gradient(\n                  circle,\n                  color-mix(in srgb, var(--ui-color-primary-500) 18%, transparent) 0%,\n                  transparent 60%\n               )" }
		}, null, -1)], 64)) : e.pattern === "mesh" ? (M(), d("div", Tl, [...n[20] ||= [
			f("div", {
...
}, kl = { class: "text-center" }, Al = { class: "mx-auto" }, jl = { class: "mt-4 text-lg sm:text-xl" }, Ml = /*#__PURE__*/ ml(/* @__PURE__ */ _({
	__name: "AppErrorInfo",
	props: { errorText: {} },
	setup(e) {
		function t() {
		...
		return (n, r) => {
			...
			return M(), l(a, { class: "p-2 sm:p-10 w-full" }, {
				...
				default: U(() => [f("div", kl, [
					f("div", Al, [h(bl, { class: "mx-auto max-w-70 text-primary slow-pulse" })]),
					f("p", jl, z(e.errorText || "Something went wrong! We have been notified about this automatically. Try refreshing the page or come back later."), 1),
					h(i, {
						label: "Retry",
						type: "button",
	...
	setup(e) {
		return (t, n) => {
			...
			return M(), d("div", null, [h(a, {
				...
				default: U(() => [e.showLoading ? (M(), d("div", Nl, [f("div", Pl, [L(t.$slots, "preloader", {}, () => [h(r, {
					name: "i-lucide-loader-circle",
					class: "size-8 mx-auto animate-spin text-primary",
					"aria-label": "Loading"
				}), e.loadingText ? (M(), d("div", Fl, z(e.loadingText), 1)) : (M(), d("span", Il, "Loading..."))], !0)])])) : e.showError ? (M(), d("div", Ll, [L(t.$slots, "error", {}, () => [h(Ml, {
					errorText: e.errorText,
					class: "max-w-xl"
				}, null, 8, ["errorText"])], !0)])) : (M(), d("div", Rl, [L(t.$slots, "default", {}, void 0, !0)]))]),
				_: 3
			})]);
		};
	}
}), [["__scopeId", "data-v-3aa83326"]]), Bl = {
	key: 0,
	class: "bar"
}, Vl = /*#__PURE__*/ ml(/* @__PURE__ */ _({
	...
	setup(e) {
		...
		let t = e;
		return (t, n) => e.isLoading ? (M(), d("div", Bl, [...n[0] ||= [f("div", null, null, -1)]])) : u("", !0);
	}
}), [["__scopeId", "data-v-bacfecf1"]]), Hl = {
	slots: {
...
}, Wl = { class: "dialog-loader" }, Gl = { class: "flex flex-col justify-center" }, Kl = {
	key: 0,
	...
	setup(e) {
		return (t, n) => {
			...
			return M(), d("div", Wl, [h(i, {
				...
				}), e.loadingText ? (M(), d("div", Kl, z(e.loadingText), 1)) : u("", !0)])]),
				_: 1
			}, 8, ["open", "title"])]);
		};
	}
}), Jl = { base: "animate-pulse rounded-md bg-elevated" }, Yl = {
	__name: "Skeleton",
	props: {
		as: {
			type: null,
...
}), Zl = { class: "flex flex-col m-0 p-0" }, Ql = { class: "flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4 py-6 border-b border-default first:pt-0 last:border-b-0 last:pb-0" }, $l = { class: "min-w-0 m-0 text-default" }, eu = {
	key: 1,
	...
	setup(e) {
		return (t, n) => {
			let r = Yl, i = Ol;
			return M(), l(i, null, {
				header: U(() => [L(t.$slots, "header", {}, () => [h(gl, {
					tag: "h2",
					textSize: "md",
					class: "heading-mb-sm"
				}, {
					default: U(() => [m(z(e.headingText), 1)]),
					_: 1
				})])]),
...
var fu = class e extends Error {
...
}), Ou = { key: 0 }, ku = { class: "text-primary break-all px-2" }, Au = /* @__PURE__ */ _({
	...
	setup(t, { emit: n }) {
		...
		return (e, n) => {
			let r = Cu, i = bu, u = il, p = mu, g = Ol;
			return M(), l(g, null, {
				header: U(() => [L(e.$slots, "header", {}, () => [h(gl, {
					tag: "h2",
					textSize: "md",
					class: "heading-mb-sm"
				}, {
					default: U(() => [m(z(t.headingText), 1)]),
					_: 1
				})])]),
		...
		return (t, r) => {
			...
			return M(), l(o, null, {
				...
				default: U(() => [n.isDeleteEmailSent ? (M(), l(Du, {
					...
					_: 1
				})) : (M(), d("div", ju, [r[0] ||= f("p", null, " You will receive an email to verify your account deletion. Please click on the email link to delete your account. ", -1), h(a, {
...
}), Nu = { class: "gsi-material-button-content-wrapper" }, Pu = { class: "gsi-material-button-icon" }, Fu = {
	version: "1.1",
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	"xmlns:xlink": "http://www.w3.org/1999/xlink",
	style: { display: "block" }
}, Iu = { class: "gsi-material-button-contents" }, Lu = { style: { display: "none" } }, Ru = /*#__PURE__*/ ml(/* @__PURE__ */ _({
	...
	setup(t, { emit: n }) {
		...
		return (e, n) => {
			let i = Cu, g = bu, _ = il, v = mu, y = Ol;
			return M(), l(y, { class: "max-w-xl w-full" }, {
				header: U(() => [h(gl, {
					tag: "h1",
					textSize: "lg",
					class: "heading-mb-sm"
				}, {
					default: U(() => [m(z(t.title), 1)]),
					_: 1
				})]),
				default: U(() => [
					L(e.$slots, "notice"),
					L(e.$slots, "oauth-providers"),
					r["oauth-providers"] ? (M(), d("div", zu, [...n[1] ||= [
...
}, Hu = /*@__PURE__*/ Object.assign({ inheritAttrs: !1 }, {
	__name: "Separator",
	props: {
		as: {
			type: null,
...
}, Gu = { class: "px-4 py-8 sm:p-8" }, Ku = { class: "max-w-xl mx-auto mb-2" }, qu = { class: "vstack-form" }, Ju = { class: "flex justify-center sm:justify-start" }, Yu = { class: "vstack-form" }, Xu = /* @__PURE__ */ _({
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => {
			let r = il, a = Wu, o = bu, s = Hu, c = Ol;
			return M(), d("div", Gu, [f("div", Ku, [h(r, {
				type: "button",
				variant: "ghost",
				...
				default: U(() => [f("form", {
					...
					h(s),
					f("div", Yu, [L(t.$slots, "resend-description"), h(r, {
...
//#endregion
export { Du as ActionConfirmMsg, Ml as AppErrorInfo, Au as ChangeEmailRequest, Mu as DeleteAccountRequest, ql as DialogLoader, Ru as GoogleAuthIcon, gl as Heading, Xl as InputSkeleton, bl as PageErrorIcon, Vl as PageInfiniteLoader, zl as PageLoader, hl as ScrollToTop, El as SectionPattern, Bu as SignInUpForm, Xu as SignInUpVerifyCode, fl as SiteNavigation, iu as UserAccountInfo };
